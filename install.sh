...
if sudo dpkg -l | grep -q "alacritty" || which alacritty > /dev/null; then
   ...
   wget -q https://github.com/barnumbirr/alacritty-debian/releases/download/v0.12.0-1/alacritty_0.12.0_amd64_bullseye.deb &>> kalighost.out
   sudo dpkg -i alacritty_0.12.0_amd64_bullseye.deb &>> kalighost.out
   sudo apt install -f -y &>> kalighost.out
...
if fc-list | grep -qi "Iosevka"; then
    ...
    wget -q https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/Iosevka.zip &>> kalighost.out
    unzip Iosevka.zip -d /usr/share/fonts/nerd-fonts/Iosevka &>> kalighost.out
    rm Iosevka.zip
fi
...
if fc-list | grep -qi "RobotoMono Nerd Font"; then
    ...
    wget -q https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/RobotoMono.zip &>> kalighost.out
    unzip RobotoMono.zip -d /usr/share/fonts/nerd-fonts/RobotoMono &>> kalighost.out
    rm RobotoMono.zip
fi
